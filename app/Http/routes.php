...
Route::group(['middleware' => 'auth'] , function() {
	...
	Route::get('/elixiraid/staff-registration' , [
		'uses' => 'ElixirController@staffIndex',
		'as' => 'elixir.staff'
	]);

	Route::get('/elixiraid/hospital-buildings' , [
		'uses' => 'ElixirController@buildingIndex',
		'as' => 'elixir.building'
	]);

	Route::get('/elixiraid/hospital-departments' , [
		'uses' => 'ElixirController@departmentIndex',
		'as' => 'elixir.department'
	]);
