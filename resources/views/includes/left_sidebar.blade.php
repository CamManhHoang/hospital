          ...
          <li>
            ...
            <ul class="sub-menu">
              <li>
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="http://localhost/hospital-management-system/public/elixiraid/hospital-registration">
                      <span>Hospital Registration</span>
                    </a>
                  </li>  
                  <li>
                    <a href="http://localhost/hospital-management-system/public/elixiraid/staff-registration">
                      <span>Staff Registration</span>
                    </a>
                  </li>
                  <li>
                    <a href="http://localhost/hospital-management-system/public/elixiraid/hospital-buildings">
                      <span>Hospital Buildings</span>
                    </a>
                  </li>
                  <li>
                    <a href="http://localhost/hospital-management-system/public/elixiraid/hospital-departments">
                      <span>Hospital Departments</span>
                    </a>
                  </li>
                  <li>
                    <a href="http://localhost/hospital-management-system/public/elixiraid/hospital-floor">
                      <span>Hospital Floor</span>
                    </a>
                  </li>
                </ul>
              </li>
